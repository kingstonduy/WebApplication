 ...
 * @author kings
 */
@WebServlet(urlPatterns = {"/LoginManager"})
public class LoginManager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(s.equals(""))
            {
               out.print("wrong student id");
            ...
            else if(s.equals("admin") || student_manager.check_id(s) == true){
                Student student= student_manager.get_student(s);
                ...
                map.modifyValue("sid", student.getSid());
                map.modifyValue("sname", student.getName());
